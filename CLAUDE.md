...
> **Current phase:** product intelligence. Canonical contract:
> [docs/architecture/2026-09-08-product-intelligence-phase.md](docs/architecture/2026-09-08-product-intelligence-phase.md).
> Closure is rescinded; its repo-trust rules carry over (one canonical implementation
> per domain, honesty layers, full done-chain). PARA UI decisions are Exploration until
> the cartography gate in `research/` is met. Docs naming: [docs/CONVENTIONS.md](docs/CONVENTIONS.md).
...
// import { Brain } from "@phosphor-icons/react/dist/ssr"; // only in apps/landing/**
