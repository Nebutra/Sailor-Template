...
Same shape elsewhere in this package: `skins/*.css` and
`packages/design/theme/skins.css` are generated by `emit-skins.mjs` from
`src/brand-package/emit-css.ts`. `recipe.css` is **not** generated — the
