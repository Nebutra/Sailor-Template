...
export default function ApiDocsPage() {
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <pre className="overflow-x-auto rounded-lg border border-border bg-muted p-4 text-sm">{`curl -X POST 'http://localhost:3105/api/v1/tools/invoke/text/word-count' \\
