...
export function CopyCommand({ command, className = "" }: CopyCommandProps) {
  ...
  return (
    <button
      ...
      className={`group flex w-full items-center justify-between gap-3 rounded-md border border-[var(--neutral-7)] bg-[var(--neutral-2)] px-3 py-2 font-mono text-xs text-[var(--neutral-12)] transition-colors hover:bg-[var(--neutral-3)] focus:outline-none focus:ring-2 focus:ring-[var(--blue-9)] focus:ring-offset-1 ${className}`}
    >
