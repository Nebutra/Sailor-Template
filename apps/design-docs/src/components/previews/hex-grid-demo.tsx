      ...
      <div className="gap-12 max-w-4xl px-4 mx-auto flex flex-col">
        ...
        <div className="space-y-4">
          <div className="mb-6 text-center">
            <h3 className="text-lg font-semibold">Animated Glowing Grid</h3>
        ...
        <div className="space-y-4">
          <div className="mb-6 text-center">
            <h3 className="text-lg font-semibold">Filled Grid with Mask</h3>
            <p className="text-sm text-muted-foreground">
              Solid filled hexagons masked by a radial gradient.
            </p>
          </div>
          <div className="md:h-[400px] bg-foreground relative flex h-[300px] w-full items-center justify-center overflow-hidden rounded-xl border">
            <HexGrid
              filled
              size={32}
            ...
            <div className="relative z-10">
              <h2 className="text-4xl md:text-5xl font-semibold text-background tracking-tight mix-blend-overlay">
                NEBUTRA
              </h2>
            </div>
          </div>
