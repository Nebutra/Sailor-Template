...
export function IntroductionHero() {
  return (
    <div className="relative w-full overflow-hidden rounded-3xl border border-border bg-card shadow-sm mb-12 mt-6">
      {/* Dynamic Background */}
      ...
      <div className="relative z-10 flex flex-col items-start gap-6 px-8 py-16 md:px-12 md:py-20 lg:py-24 max-w-4xl mx-auto text-center md:text-left md:mx-0">
        ...
        <div className="flex flex-wrap items-center gap-4 mt-4 w-full justify-center md:justify-start">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg border border-border bg-background hover:bg-muted px-6 py-3 text-sm font-medium text-foreground transition-colors shadow-sm !no-underline"
          >
