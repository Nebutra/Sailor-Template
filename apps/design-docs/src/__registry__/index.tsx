...
export const SelectErrorDemo = dynamic(() =>
  import("@/components/previews/select-error-demo").then((m) => ({ default: m.SelectErrorDemo })),
);
...
export const Index: Record<string, { name: string; component: React.ComponentType }> = {
  ...
  "accordion-controlled-demo": {
    name: "accordion-controlled-demo",
  ...
  "alert-dialog-custom-demo": {
    name: "alert-dialog-custom-demo",
  ...
  "animated-shiny-text-demo": {
    ...
    component: AnimatedShinyTextDemo,
  },
  ...
  "assisted-password-confirmation-demo": {
    name: "assisted-password-confirmation-demo",
    component: AssistedPasswordConfirmationDemo,
  },
  ...
  "avatar-git-platform-demo": {
    name: "avatar-git-platform-demo",
    component: AvatarGitPlatformDemo,
  },
  ...
  "dithering-background-demo": {
    name: "dithering-background-demo",
    component: DitheringBackgroundDemo,
  },
  ...
  "grain-gradient-background-demo": {
    name: "grain-gradient-background-demo",
    component: GrainGradientBackgroundDemo,
  },
  ...
  "input-password-reveal-demo": {
    name: "input-password-reveal-demo",
    component: InputPasswordRevealDemo,
  },
  ...
  "radio-group-billing-demo": {
    ...
    component: RadioGroupBillingDemo,
  },
  ...
  "radio-group-horizontal-demo": {
    name: "radio-group-horizontal-demo",
  ...
  "toggle-group-single-demo": {
    ...
    component: ToggleGroupSingleDemo,
  },
  ...
  "tooltip-icon-button-demo": {
    name: "tooltip-icon-button-demo",
    component: TooltipIconButtonDemo,
  },
  "tooltip-instant-demo": { name: "tooltip-instant-demo", component: TooltipInstantDemo },
  "tooltip-rich-content-demo": {
    name: "tooltip-rich-content-demo",
