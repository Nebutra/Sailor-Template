...
function RevokeButton({
  ...
  return (
    <button
      ...
      disabled={pending}
      onClick={handleClick}
      className="text-xs font-medium text-red-500 transition-colors hover:text-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-1 disabled:opacity-50"
    >
    ...
    return (
      <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-[var(--neutral-7)] bg-[var(--neutral-2)] py-10 text-center">
        ...
        <button
          type="button"
          onClick={onCreate}
          className="rounded-md px-4 py-2 text-sm font-medium text-white transition-opacity hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[var(--blue-9)] focus:ring-offset-1"
