  ...
  return (
    <div className="rounded-[var(--radius-2xl)] border border-neutral-6 bg-neutral-1 p-4 dark:border-white/10 dark:bg-white/[0.03] sm:p-5">
      ...
      {sessions.length > 0 ? (
        ...
        <AnimateIn preset="fadeUp">
          <div className="flex flex-col gap-3 rounded-[var(--radius-xl)] bg-neutral-2/70 px-4 py-3 dark:bg-white/[0.035] sm:flex-row sm:items-center sm:justify-between">
            <div className="min-w-0">
            ...
            <ViewTransitionLink
              href="/chat"
              className="inline-flex shrink-0 items-center gap-1.5 rounded-[var(--radius-md)] border border-neutral-7 bg-neutral-1 px-3 py-2 text-xs font-medium text-neutral-12 transition-colors hover:border-neutral-8 hover:bg-neutral-2 dark:border-white/10 dark:bg-white/[0.04] dark:text-white dark:hover:bg-white/[0.08]"
            >
              <Plus className="size-3" aria-hidden="true" />
              {t("newChat")}
            </ViewTransitionLink>
