  ...
  return (
    <div data-dashboard-section="workspace-home" className="relative">
      <div className="mx-auto flex max-w-3xl flex-col items-center px-4 pt-16 pb-24 text-center sm:pt-24">
        ...
        <Link
          href="/integrations"
          className="inline-flex items-center gap-1.5 rounded-full bg-background/80 px-3 py-1 text-xs font-medium text-foreground/80 transition-colors hover:bg-background hover:text-foreground"
        >
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-2">
          {[
            ...
            <Link
              key={a.href}
              href={a.href}
              className="inline-flex items-center gap-1.5 rounded-full bg-background/70 px-3 py-1.5 text-xs font-medium text-foreground/80 transition-colors hover:bg-background hover:text-foreground"
            >
...
function PromptCard({ placeholder }: { placeholder: string }) {
  return (
    <div className="mt-8 w-full max-w-2xl">
      <div className="rounded-[var(--radius-2xl)] bg-background/90 p-4 shadow-[0_10px_30px_-12px_rgba(0,0,0,0.18)]">
