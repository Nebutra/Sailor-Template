  ...
  (
    ...
    return (
      ...
      <button
        ...
        className={cn(
          // allow-palette: shimmer CTA renders a fixed dark pill via --bg (defaults to rgba(0,0,0,1)), not the themed surface — ink stays fixed with it
      ...
      >
        ...
        <div
          className={cn(
            ...
            "rounded-[var(--radius-2xl)] px-4 py-1.5 text-sm font-medium shadow-[inset_0_-8px_10px_#ffffff1f]",

            // transition
            "transform-gpu transition-[background-color,box-shadow,color,opacity,transform] duration-300 ease-in-out",
