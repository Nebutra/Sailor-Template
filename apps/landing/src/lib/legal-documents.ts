/**
 * Legal-document fetcher abstraction for the landing app.
 *
 * The landing is a separate Next.js app from `/web` and does not have
 ...
 * landing's prerender sandbox) and would otherwise stall Next.js 16's
