...
const BRAND_LITERALS_DEFAULTS = {
  ...
  allowExpressions: [
    ...
    "云毓智能",
    "云毓",
    "^https?://([a-z0-9-]+\\.)?nebutra\\.com(?:/|$)",
    "^https?://([a-z0-9-]+\\.)?nebutra\\.ai(?:/|$)",
    "#0033FE",
    "#0BF1C3",
  ],
  knownExemptPatterns: [
...
const BRAND_LITERALS_BASELINE_ALLOWLIST = [
  ...
  "apps/landing/src/app/api/blog/comments/route.ts",
  "apps/landing/src/app/api/blog/reactions/route.ts",
  "apps/landing/src/app/api/og/route.ts",
  "apps/landing/src/app/apple-icon.tsx",
  "apps/landing/src/components/auth/google-one-tap.tsx",
  "apps/landing/src/components/cookie-consent-banner.tsx",
  "apps/landing/src/components/marketing/ProductHuntSection.tsx",
  "apps/landing/src/components/marketing/TestimonialsSection.tsx",
  "apps/landing/src/i18n/request.ts",
  "apps/landing/src/lib/analytics/emit.ts",
  "apps/landing/src/lib/blog-fallback.ts",
  "apps/landing/src/lib/constants/playbook-data.ts",
  "apps/landing/src/lib/constants/resources-data.ts",
  "apps/landing/src/lib/constants/solutions-data.ts",
  "apps/landing/src/lib/docs-links.ts",
  "apps/landing/src/lib/env.ts",
  "apps/landing/src/lib/landing-content.ts",
  "apps/landing/src/lib/seo/metadata.ts",
  "apps/landing/src/lib/seo/site-routes.ts",
  "apps/landing/src/lib/status-checks.ts",
