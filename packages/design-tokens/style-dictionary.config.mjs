 ...
 * Output goes to ./build/* and to packages/tokens/styles.css and packages/theme/themes.css
 ...
 * AUTO-GENERATED from packages/design-tokens/tokens/*.json — DO NOT EDIT.
...
// packages/tokens/styles.css. Contains :root + .dark + extras + @theme inline + base.
const stylesCombined = `${generatedHeader}${lightFinal}\n${darkFinal}\n${tailwindBlock}\n${baseCss}`;
await writeFile("build/css/styles.generated.css", stylesCombined, "utf8");

// themes.generated.css — replacement for packages/theme/themes.css.
 ...
 * AUTO-GENERATED from packages/design-tokens/tokens/themes/*.json — DO NOT EDIT.
 *
...
process.stdout.write(
  "\n[design-tokens] build complete\n" +
    "  → build/css/styles.generated.css   (replaces packages/tokens/styles.css)\n" +
    "  → build/css/themes.generated.css   (replaces packages/theme/themes.css)\n",
);
