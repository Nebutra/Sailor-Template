...
export function AnalyticsProvider({
  ...
  const sendEvent = useCallback(
    async (eventType: string, data: Record<string, unknown>) => {
      if (!canTrack) {
        // biome-ignore lint/suspicious/noConsole: client-side debug log gated by `debug` flag
...
export function trackEvent(input: TrackEventInput): void {
  ...
  fetch("/api/analytics/track", {
    ...
    // biome-ignore lint/suspicious/noConsole: silent client-side debug log on tracking failure
