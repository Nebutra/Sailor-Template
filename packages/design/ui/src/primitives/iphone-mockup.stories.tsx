...
function CapturedMobileScreen() {
  return (
    <div
      ...
      className="flex size-full flex-col gap-5 bg-neutral-1 px-6 py-12 text-neutral-12"
    >
      <div className="space-y-2">
        <div className="h-3 w-24 rounded-[var(--radius-full)] bg-neutral-12" />
        <div className="h-2 w-40 rounded-[var(--radius-full)] bg-neutral-8" />
      </div>
      <div className="rounded-[var(--radius-xl)] border border-border bg-neutral-2 p-5">
        <div className="h-3 w-28 rounded-[var(--radius-full)] bg-neutral-12" />
        <div className="mt-5 h-2 w-48 rounded-[var(--radius-full)] bg-primary" />
        <div className="mt-3 h-2 w-32 rounded-[var(--radius-full)] bg-neutral-7" />
      </div>
      <div className="grid grid-cols-2 gap-3">
        {["Deployments", "Credits"].map((label) => (
          <div
            ...
            key={label}
          >
            <div className="h-2 w-16 rounded-[var(--radius-full)] bg-neutral-8" />
            <div className="mt-5 h-4 w-20 rounded-[var(--radius-full)] bg-neutral-12" />
          </div>
        ))}
      </div>
      <div className="mt-auto space-y-3 rounded-[var(--radius-xl)] border border-border bg-background p-4">
        {[0, 1, 2].map((item) => (
          <div className="flex items-center gap-3" key={item}>
            <div className="size-8 rounded-[var(--radius-full)] bg-neutral-4" />
            <div className="min-w-0 flex-1 space-y-2">
              <div className="h-2 rounded-[var(--radius-full)] bg-neutral-9" />
              <div className="h-2 w-2/3 rounded-[var(--radius-full)] bg-neutral-6" />
            </div>
          </div>
        ))}
      </div>
