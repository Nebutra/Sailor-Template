  ...
  return (
    ...
    >
      ...
      {!hasVideo && imageSrc && (
        ...
        >
          <Image src={imageSrc} alt="" className="block size-full object-cover object-top" fill />
        </div>
      )}
      ...
      >
        ...
        <g clipPath="url(#path0)" mask={hasMedia ? "url(#safariPunch)" : undefined}>
          ...
          <path
            ...
            // allow-palette: depicts Safari's own chrome (Apple's window bar colours), not app UI
