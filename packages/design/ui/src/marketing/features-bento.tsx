...
export interface BentoFeatureCard {
  /** Card icon */
  icon: LucideIcon;
  /** Card title */
  title: string;
...
export interface BentoTeamMember {
  /** Member name */
  name: string;
  /** Avatar URL */
  avatar: string;
...
export interface FeaturesBentoSectionProps {
  /** Stat card content */
  statCard?: BentoStatCard;
  ...
  /** Left feature card */
  leftFeatureCard?: BentoFeatureCard;
  /** Right feature card */
  rightFeatureCard?: BentoFeatureCard;
  /** Team members for the team card */
  teamMembers?: BentoTeamMember[];
  /** Additional className */
  className?: string;
}

/**
 * FeaturesBentoSection - Bento grid layout for features
 *
 * A visually rich features section with 6 cards in a bento grid layout.
 * Includes decorative SVG charts and patterns.
 */
export function FeaturesBentoSection({
  statCard = { value: "100%", title: "Customizable" },
  securityCard = {
  ...
  leftFeatureCard = {
    ...
    description: "Handle millions of requests with ease.",
  },
  rightFeatureCard = {
    icon: Users,
  ...
  const LeftIcon = leftFeatureCard.icon;
  const RightIcon = rightFeatureCard.icon;

  return (
    <section className={cn("bg-muted/30 py-16 md:py-32 dark:bg-transparent", className)}>
      <div className="mx-auto max-w-3xl px-6 lg:max-w-content">
...
FeaturesBentoSection.displayName = "FeaturesBentoSection";
...
/** Decorative SVG for security card */
