  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
        <button
          type="button"
          className="group relative flex flex-col items-center justify-center p-4 border-r border-b border-border bg-card/10 hover:bg-card focus-visible:bg-card focus-visible:outline-none focus-visible:relative focus-visible:z-10 transition-colors h-[120px] outline-none"
        ...
        >
          ...
          <span
            className="text-[11px] text-muted-foreground text-center px-1 font-medium truncate w-full"
            title={name}
          >
            {name}
          </span>
