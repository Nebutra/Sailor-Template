...
function FlowNode({
  ...
  return (
    <div
      ref={ref}
      className="relative z-10 flex min-w-28 flex-col items-center gap-2 rounded-lg border border-border bg-background px-3 py-3 text-center shadow-sm dark:border-white/10 dark:bg-muted"
    >
