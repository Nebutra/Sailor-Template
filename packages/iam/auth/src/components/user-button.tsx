  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-full bg-[var(--neutral-3)] text-xs font-medium text-[var(--neutral-12)]"
      >
        {user.imageUrl ? (
      ...
      {open && (
        <div className="absolute right-0 top-10 z-50 w-56 rounded-lg border border-[var(--neutral-7)] bg-[var(--neutral-1)] py-1 shadow-lg">
          ...
          <button
            ...
            className="w-full px-3 py-2 text-left text-sm text-[var(--neutral-11)] transition-colors hover:bg-[var(--neutral-3)] focus:outline-none focus:ring-2 focus:ring-inset"
          >
            Sign out
          </button>
        </div>
