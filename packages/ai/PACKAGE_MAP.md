...
| `product-orchestration` | `@nebutra/cinema`, `@nebutra/play-loader`, `@nebutra/startup-os`, `@nebutra/workflow-runtime` | Declarative product workflows over lower runtime/tool/media surfaces. |
