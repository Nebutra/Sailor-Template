...
function evalScript(store: Store, script: string, keys: string[], args: string[]): unknown {
  ...
  return [state, String(failures), String(successes), openedAt === null ? "" : String(openedAt)];
}
