...
<table>
  <tr>
    ...
    <td width="33%" valign="top">
      ...
      <br />Cloudflare WAF/R2, Inngest workflows, Sentry/Otel, Fly.io deployments.
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
...
**Building a commercial product on {{repo.name}} is free.** No fee, no
...
The only thing the code licence does not permit is making {{brand.name}} Sailor
...
own product something unrelated needs no permission; using the {{brand.name}}
...
Copyright is held by {{company.name}}
