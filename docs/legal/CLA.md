...
**"You" (or "Your")** means the individual copyright owner, or the legal
entity authorized by the copyright owner, that is making this Agreement
with Nebutra Technologies.

**"Contribution"** means any original work of authorship, including any
modifications or additions to an existing work, that is intentionally
submitted by You to Nebutra Technologies for inclusion in, or
documentation of, any of the products owned or managed by Nebutra
Technologies (the "Work"). For the purposes of this definition,
"submitted" means any form of electronic, verbal, or written
communication sent to Nebutra Technologies or its representatives,
including but not limited to communication on electronic mailing lists,
source code control systems, and issue tracking systems that are managed
by, or on behalf of, Nebutra Technologies for the purpose of discussing
and improving the Work.

**"Nebutra Technologies"** means the legal entity operating the
Nebutra-Sailor open-source project at `https://github.com/Nebutra/Nebutra-Sailor`.

## 2. Grant of Copyright License

Subject to the terms and conditions of this Agreement, You hereby grant
to Nebutra Technologies and to recipients of software distributed by
Nebutra Technologies a perpetual, worldwide, non-exclusive, no-charge,
...
## 4. Dual-Licensing Grant (Nebutra-specific)

You explicitly acknowledge and agree that Nebutra Technologies may
...
may submit it to Nebutra Technologies separately from any Contribution,
...
third-party: [name here]"`.

## 8. Authority to Bind Employer

If You are employed and Your employer(s) has rights to intellectual
property that You create which includes Your Contributions, You
represent that You have received permission to make Contributions on
behalf of that employer, that Your employer has waived such rights for
Your Contributions to Nebutra Technologies, or that Your employer has
executed a separate Corporate CLA with Nebutra Technologies.

## 9. Accurate Information

You agree to notify Nebutra Technologies of any facts or circumstances
...
When you open your first pull request, the CLA bot will comment with a
sign link. The fastest way to sign is to reply to that comment with the
exact phrase:

> I have read the CLA Document and I hereby sign the CLA

Your signature is bound to your GitHub identity and covers all your
future contributions — you only sign once.

See [`contributing-with-cla.md`](./contributing-with-cla.md) for the
